...
class ExtensionsControllerTest < ActionController::TestCase
  ...
  test "should create extension" do
    assert_difference('Extension.count') do
      post :create, extension: { department: @extension.department, email: @extension.email, extension: @extension.extension, name: @extension.name }
    end
  ...
  test "should update extension" do
    patch :update, id: @extension, extension: { department: @extension.department, email: @extension.email, extension: @extension.extension, name: @extension.name }
    assert_redirected_to extension_path(assigns(:extension))
  end
